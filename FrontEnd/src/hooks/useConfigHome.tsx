...
import useQueryParams from './useQueryParams'  // Import hook để lấy các tham số truy vấn từ URL
...
// Hook chính để lấy và cấu hình các tham số truy vấn từ URL
export default function useConfigHome() {
  // Lấy các tham số truy vấn từ hook useQueryParams
  ...
  const queryConfig: QueryConfig = omitBy(
    {
      ...
      limit: queryParams.limit || '50',  // Nếu không có tham số 'limit', mặc định là '50'
